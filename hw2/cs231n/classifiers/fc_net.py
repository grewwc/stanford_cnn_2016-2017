...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        loss, grad_softloss = softmax_loss(scores, y)
        loss += 0.5 * self.reg * (np.sum(self.params['W1'] ** 2)
                                  + np.sum(self.params['W2'] ** 2))

        grad_out3, grads['W2'], grads['b2'] = affine_backward(grad_softloss, cache3)
        grads['W2'] += 1.0 * self.reg * self.params['W2']

        grads_out2 = relu_backward(grad_out3, cache2)

        grads_out1, grads['W1'], grads['b1'] = affine_backward(grads_out2,
                                                               cache1)
        grads['W1'] += 1.0 * self.reg * self.params['W1']
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
