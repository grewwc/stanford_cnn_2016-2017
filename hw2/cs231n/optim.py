...
def adam(w, dw, config=None):
    ...
    beta1_unbiased = config['m'] / (1-np.power(config['beta1'], config['t']))

    config['v'] = config['beta2']*config['v'] + (1.0 - config['beta2'])*dw**2
    beta2_unbiased = config['v'] / (1-np.power(config['beta2'], config['t']))
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
    next_w = w - config['learning_rate']*beta1_unbiased / \
        (np.sqrt(beta2_unbiased) + config['epsilon'])
